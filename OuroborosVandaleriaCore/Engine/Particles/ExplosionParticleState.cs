...
namespace OuroborosVandaleriaCore.Engine.Particles
{
    public class ExplosionParticleState : EmitterParticleState
    {
        ...
        public override float OpactiyFadingRate => 0.92f;
    ...
    public class ExplosionEmitter : Emitter
    {
        ...
        public ExplosionEmitter(Texture2D texture, Vector2 position) : base(texture, position, new ExplosionParticleState(), new CircleEmitterType(Radius), NbParticles, MaxParticles)
        {
